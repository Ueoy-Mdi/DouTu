 ...
 * 瀑布流适配器//
 */
public class HomePictureAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HomePictureAdapter(List<HomeImgEntity.DataBean> mNews, Context mContext) {
        this.mNews = mNews;
