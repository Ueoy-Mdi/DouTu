 ...
 * 瀑布流适配器//
 */
public class SearchPictureAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SearchPictureAdapter(List<SearchEntity.DataBean> mNews, Context mContext) {
        this.mNews = mNews;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == NOMAL)
            ...
            return new FooterHolder(View.inflate(mContext, R.layout.item_footer, null));
    }
